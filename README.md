...
- PERMANOVA to test the effects of ecosystem, soil moisture content, and elevation on community dissimilarity
...
Principal Coordinates Analysis of presence–absence transformed plant species data revealed two distinct clusters corresponding to the two ecosystems. Soil moisture showed a directional correlation with community composition when fitted using `envfit`. <br>
<br>
...
Distance to centroid (beta diversity) was plotted against soil moisture content for each quadrat. Soil moisture was log10 transformed for normality and visualization. Linear regresion models suggest a correlation between soil moisture content and beta diveristy. <br>
<br>
